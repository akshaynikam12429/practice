...
{   
    ...
    snprintf(query,MAX_STRING,"INSERT INTO esb_request(message_id,message_type,sender_id,dest_id,received_on,reference_id,data_location,status_details)  VALUES('%s','%s','%s','%s','%s','%s','%s','%s')",b.envelop.messageId,b.envelop.messageType,b.envelop.sender,b.envelop.destination,b.envelop.creationDateTime,b.envelop.referenceId,bmd_file_path,initial_status);
